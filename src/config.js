// Things that change at launch or later. Everything here is public; nothing is a secret.
export const SITE_NAME = "Specdle";
export const SITE_URL = "https://specdle.com"; // share text footer
export const MAX_GUESSES = 8;
// Amazon Associates tracking id, e.g. "specdle-20". Empty = no affiliate links rendered.
export const AMAZON_TAG = "specdle-20";
